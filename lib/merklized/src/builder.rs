...
/// functionality, but for building `[merklized::MerklizedAtomo]` instances instead of
...
> MerklizedAtomoBuilder<C, S, M>
{
    ...
    /// instance, but augments by first building with the merklized strategy, so that the state tree
