...
impl TestNode {
    pub async fn run_transaction(&self, transaction: TransactionRequest) -> Result<()> {
        // TODO(snormore): Why not go through the RPC for this?
        // TODO(snormore): Can we get a block transaction response for this transaction and return
        // it?
        ...
        wait_until(
            ...
            // TODO(snormore): Lower the mock consensus delay so this timeout can be lower. Make
            // mock consensus delay < 1s by default but configurable.
