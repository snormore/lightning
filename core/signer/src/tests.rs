...
//     // The signer will notice that the nonce doesn't increment on the application after the
// second     // transaction, and then it will resend all following transactions.
