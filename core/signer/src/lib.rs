...
//                     {
//                         // If transaction reverts or we reached the maximum number of retries,
// don't                         // retry again.
//                         // To prevent invalidating the nonces of the following pending
// transactions,                         // we have to increment the nonce on the application state.
